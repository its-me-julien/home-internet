...
const JoinDiscussion: React.FC = () => {
  ...
  const structuredData = {
    ...
    description:
      "Join the World Mobile Club community to discuss home internet services, share reviews, connect with other customers, and stay informed about the latest developments.",
    mainEntity: [
      {
        "@type": "DiscussionForumPosting",
        name: "Home Internet Reviews",
        headline: "Share and read genuine reviews of World Mobile Home Internet",
        url: "https://worldmobile.club/c/world-mobile-customers/world-mobile-customer-reviews/68",
        description:
          "Explore authentic reviews about World Mobile Home Internet. Learn from customer experiences to make informed decisions.",
        author: {
          "@type": "Person",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <article className="bg-white rounded-lg shadow-lg border border-gray-200 transition-transform hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-600 mt-4">
                Join discussions about World Mobile Home Internet services,
                celebrate milestones, and connect with the community.
              </p>
              <div className="mt-6">
                <a
