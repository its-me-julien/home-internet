...
const ReviewForm = () => {
  ...
  <h2 className="text-xl font-semibold text-white leading-snug">
    Share Your Experience with <span className="text-white">World Mobile Home Internet</span>
  </h2>
  <p className="text-sm text-gray-200 leading-relaxed">
    Help others choose the best home internet service by sharing your experience. Your feedback builds trust and empowers the World Mobile community.
  </p>
  ...
  <div className="space-y-4">
    ...
    <p className="text-sm text-gray-200 leading-relaxed">
      Reviews from real customers provide transparency and honesty. By sharing your experience, you help others understand what it’s like to use World Mobile Home Internet.
    </p>
  </div>
  ...
  <div className="space-y-4">
    ...
    <ul className="space-y-3 list-disc list-inside text-sm text-gray-200">
      <li>
        <strong className="text-white">Be Specific:</strong> Mention details about connection speed, reliability, and customer support.
      </li>
      <li>
        <strong className="text-white">Stay Honest:</strong> Share both the positives and areas for improvement in your experience.
      </li>
      <li>
        <strong className="text-white">Share Your Journey:</strong> Talk about the setup process, daily use, and overall satisfaction.
      </li>
    </ul>
  </div>
</div>
